  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden text-white">
      <div className="absolute inset-0">
        <div className="absolute inset-0 overflow-y-scroll" ref={scrollRef}>
          <div className="hidden md:block fixed left-0 top-0 h-full xl:w-120 lg:w-100 md:w-80 bg-gray-900/95 backdrop-blur-sm border-l border-gray-700 z-10">
            ...
            <div className="max-w-4xl mx-auto px-8 py-16">
              ...
              <section id="about" className="mb-20">
                <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  <h2 className="hidden md:block text-4xl font-bold mb-8 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                    About Me
                  </h2>
