...
const skills = [
  ...
  },
  {
    ...
    items: ["AWS", "Docker", "Kubernetes", "CI/CD", "Terraform", "Redis"]
  },
  {
    category: "Tools & Others",
    items: ["Git", "GraphQL", "REST APIs", "Jest", "Webpack", "Figma"]
  }
];
...
const experiences = [
  {
    ...
    period: "2022 - Present",
    description: "Led development of scalable web applications serving 100K+ users. Architected microservices infrastructure and mentored junior developers. Improved application performance by 40% through optimization strategies.",
  ...
  },
  {
    ...
    company: "StartupXYZ",
    period: "2020 - 2022",
    description: "Built MVP from scratch using modern tech stack. Implemented real-time features, payment integration, and responsive design. Collaborated with design team to create intuitive user experiences.",
    technologies: ["Vue.js", "Python", "Django", "MongoDB", "Stripe", "SASS"]
  },
  {
    id: 3,
    ...
    period: "2019 - 2020",
    description: "Developed responsive websites and web applications for various clients. Focused on performance optimization and cross-browser compatibility. Worked closely with UX/UI designers.",
    technologies: ["JavaScript", "React", "CSS3", "Webpack", "Git", "Figma"]
  }
];
          ...
          <div className="flex flex-col h-full p-8">
            <div className="mt-10">
              ...
              <div className={`mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
                {/* <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 p-1">
              ...
              <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700">
                  ...
                  <p className="text-lg text-gray-300 leading-relaxed mb-8">
                    My expertise spans from frontend development with React and Vue.js to backend systems using Node.js and Python. 
